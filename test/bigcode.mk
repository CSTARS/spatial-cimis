...
${old}.bigcode.xml:
	time curl --silent 'http://${old}/wms/wms.cgi?TIME=${start}:${stop}&VERSION=1.1&REQUEST=GetFeatureInfo&ZIPCODE=${zipcodes}' >  ${old}.bigcode.xml 

${new}.bigcode.xml:
	time curl --silent 'http://${new}/wms/wms.cgi?TIME=${start}:${stop}&VERSION=1.1&REQUEST=GetFeatureInfo&ZIPCODE=${zipcodes}' > ${new}.bigcode.xml
